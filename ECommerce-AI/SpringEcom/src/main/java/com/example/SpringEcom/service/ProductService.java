...
public class ProductService {
    ...
    public String generateDescription(String name, String category) {
        ...
        String desc = chatClient.prompt(descPrompt)
                ...
                .getText();
//        return desc;
        return "Experience power and elegance in your hands. With a sleek design, stunning display, and all-day performance, it’s built to keep you connected, capture every moment beautifully, and make everyday tasks effortless.";
    }
